...
const images = {
    1: 
        ["https://i.imgur.com/otf92SC.png", "https://i.imgur.com/y3B0YHz.jpeg", "https://photos.app.goo.gl/bSzSPW8oPpcgGoF6A",
        ]
...
const verses = {
    ...
    "I am now confused about my duty and have lost all composure because of weakness. In this condition, I am asking You to tell me clearly what is best for me. Now I am Your disciple, and a soul surrendered unto You. Please instruct me.",
    ...
    "He who is without affection either for good or evil in his mind is firmly fixed in perfect knowledge.",
    ...
    "For one who is so situated in the Divine, the threefold miseries of material existence exist no longer; in such a happy state, one's intelligence soon becomes steady.",
    ...
    "Let not the wise disrupt the minds of the ignorant who are attached to fruitive action. They should not be discouraged, but encouraged, by working in the spirit of devotion.",
    ...
    "Thus knowing oneself to be transcendental to material intelligence, mind, and senses, O mighty-armed Arjuna, one should steady the mind by deliberate spiritual intelligence [Krsna consciousness] and thus—by spiritual strength—conquer this insatiable enemy known as lust."
    ],
    4: [
